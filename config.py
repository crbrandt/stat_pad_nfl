...
STAT_QUALIFIERS = {
    ...
    # =========================================================================
    # FANTASY POINT THRESHOLDS - Position specific (more strategic)
    # =========================================================================
    'qb_300_fantasy_pts': {
        'display': '300+ Fantasy Pts (QB)',
        'type': 'threshold',
        ...
        'qualifier_type': 'same_season',
        'eligible_positions': ['QB'],
        'eligible_stat_types': ['PASSING', 'FANTASY'],
    },
    'qb_350_fantasy_pts': {
        'display': '350+ Fantasy Pts (QB)',
        'type': 'threshold',
        'column': 'fantasy_points',
        'operator': '>=',
        'value': 350,
    ...
    # =========================================================================
    # ADDITIONAL STAT THRESHOLDS - More strategic values
    # =========================================================================
    'qb_700_rush_yards': {
        'display': '700+ Rush Yards (QB)',
        'type': 'threshold',
        'column': 'rushing_yards',
        'operator': '>=',
        'value': 700,
    ...
    # =========================================================================
    # CAREER-BASED QUALIFIERS (anytime in career)
    # =========================================================================
    'career_10000_pass_yards': {
        'display': '10,000+ Career Pass Yards',
        'type': 'career_threshold',
        'column': 'passing_yards',
        'operator': '>=',
        'value': 10000,
        'qualifier_type': 'career',
        'eligible_positions': ['QB'],
        'eligible_stat_types': ['PASSING', 'FANTASY'],
    },
    'career_20000_pass_yards': {
        'display': '20,000+ Career Pass Yards',
        'type': 'career_threshold',
        'column': 'passing_yards',
        'operator': '>=',
        'value': 20000,
    ...
    'career_5000_rush_yards': {
        'display': '5,000+ Career Rush Yards',
        'type': 'career_threshold',
        'column': 'rushing_yards',
        'operator': '>=',
        'value': 5000,
        'qualifier_type': 'career',
        'eligible_positions': ['RB', 'FB', 'QB'],
        'eligible_stat_types': ['RUSHING', 'FANTASY'],
    },
    'career_10000_rush_yards': {
        'display': '10,000+ Career Rush Yards',
        'type': 'career_threshold',
        'column': 'rushing_yards',
        'operator': '>=',
        'value': 10000,
    ...
    'career_5000_rec_yards': {
        'display': '5,000+ Career Rec Yards',
        'type': 'career_threshold',
        'column': 'receiving_yards',
        'operator': '>=',
        'value': 5000,
    ...
    'career_10000_rec_yards': {
        'display': '10,000+ Career Rec Yards',
        'type': 'career_threshold',
        'column': 'receiving_yards',
        'operator': '>=',
        'value': 10000,
    ...
    'career_500_receptions': {
        'display': '500+ Career Receptions',
        'type': 'career_threshold',
        'column': 'receptions',
        'operator': '>=',
        'value': 500,
